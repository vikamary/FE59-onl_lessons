// ДЗ!!!!!!!!!!
// Задачи в одном файле разделять комментом с номером задачи
...
// Читаемо назвать свои комиты и ветки (при форке фетку с ДЗ называть также как и занятие + фамилия и имя, например lesson_16_Karas_Evgen)
...
// https://github.com/belka215/JavaScript